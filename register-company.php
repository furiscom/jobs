   ...
   <section class="content-header">
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">BUAT PROFILE PERUSAHAAN</h1>
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              if(isset($_SESSION['registerError'])) {
                ?>
                <div>
                  <p class="text-center" style="color: red;">Email sudah ada! Pilih Email yang Berbeda!</p>
                </div>
              <?php
            ...
            <div class="col-md-6 latest-job ">
              ...
              <div id="stateDiv" class="form-group" style="">
                <select class="form-control  input-lg" id="state" name="state" required>
                  <option value="" selected="">Pilih Provinsi</option>
                </select>
              </div>   
              <div id="cityDiv" class="form-group" style="">
