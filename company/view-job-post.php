...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Job</b> Ar-Raudhoh</span>
    </a>
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="my-job-post.php"><i class="fa fa-file-o"></i>  Job Post Saya</a></li>
                  <li><a href="job-applications.php"><i class="fa fa-file-o"></i>Lamaram Job </a></li>
                  ...
                  <li><a href="resume-database.php"><i class="fa fa-user"></i> Lanjutkan Database</a></li>
            ...
            <div class="row margin-top-20">
              ...
              <?php
               $sql = "SELECT * FROM job_post WHERE id_company='$_SESSION[id_company]' AND id_jobpost='$_GET[id]'";
                ...
                <hr>
                <div>
                  <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['experience']; ?> Lama Pengalaman (tahun)</span> <i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></p>              
                </div>
                <div>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="https://simas.masjidarraudhohtelanaipura.net/">Jobs Masjid Ar-Raudhoh</a>.</strong> All rights
    reserved.
    </div>
  </footer>
