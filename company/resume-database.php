      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="resume-database.php"><i class="fa fa-user"></i> Resume/CV Database</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Database Bertalenta</i></h2>
            <p>Di bagian ini Anda dapat mengunduh resume semua kandidat yang melamar ke posting pekerjaan Anda</p>
              ...
              <div class="col-md-12">
                <div class="box-body table-responsive no-padding">
                  <table id="example2" class="table table-hover">
                    <thead>
                      <th>Pelamar</th>
                      <th>Kualifikasi Tertinggi</th>
                      <th>Skil</th>
                      <th>Kota</th>
                      <th>Provinsi</th>
                      <th>Download Resume/CV</th>
                    </thead>
                    <tbody>
                    <?php
