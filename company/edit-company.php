      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="edit-company.php"><i class="fa fa-tv"></i> Perusahaan Saya</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Perusahaan Saya</i></h2>
            <p>Di bagian ini Anda dapat mengubah detail perusahaan Anda</p>
            <div class="row">
              <form action="update-company.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-6 latest-job ">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success">Perbaharui Profil Perusahaan</button>
                  </div>
                </div>
                <div class="col-md-6 latest-job ">
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Ubah Logo Perusahaan</label>
