        ...
        <div class="row">
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <div class="alert alert-info alert-dismissible">
                ...
                <i class="icon fa fa-info"></i> Di dasbor ini Anda dapat mengubah pengaturan akun, memposting, dan mengelola pekerjaan Anda. ada pertanyaan? Jangan ragu untuk mengirimi kami surat.
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Job Telah diposting</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Lamaran Untuk Jobs</span>
                    <?php
