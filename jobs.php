...
<head>
  ...
  <title>Job Masjid Ar-Raudhoh Telanaipura</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Job</b> Masjid Ar-Raudhoh Telanaipura</span>
    </a>
    ...
    <section class="content-header">
      <div class="container">
        <div class="row">
          ...
          <h1 class="text-center"> Jobs Paling baru</h1>  
                ...
                <ul class="nav nav-pills nav-stacked tree" data-widget="tree">
                  <li class="treeview menu-open">
                    ...
                    <ul class="treeview-menu">
                      <li><a href=""  class="citySearch" data-target="Jambi"><i class="fa fa-circle-o text-yellow"></i> Jambi</a></li>
                      <li><a href="" class="citySearch" data-target="telanaipura"><i class="fa fa-circle-o text-yellow"></i> Telanaipura</a></li>
                    </ul>
                  </li>
                  <li class="treeview menu-open">
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="learningfromscratch.online">Job Masjid Ar-Raudhoh Telanaipura</a>.</strong> All rights
    reserved.
    </div>
  </footer>
