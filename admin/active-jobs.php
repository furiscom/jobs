      ...
      <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="active-jobs.php"><i class="fa fa-briefcase"></i> Jobs yang aktif</a></li>
                  <li><a href="applications.php"><i class="fa fa-address-card-o"></i> Lamaran-lamaran</a></li>
                  <li><a href="companies.php"><i class="fa fa-building"></i> Perusahaan-Perusahaan</a></li>
          ...
          <div class="col-md-9 bg-white padding-2">
            ...
            <h3>Jobs yang aktif telah di post</h3>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Judul Job </h4>
          </div>
