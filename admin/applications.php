            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="active-jobs.php"><i class="fa fa-briefcase"></i> Jobs yang aktif</a></li>
                  <li class="active"><a href="applications.php"><i class="fa fa-address-card-o"></i> Pelamar</a></li>
                  <li><a href="companies.php"><i class="fa fa-building"></i> Perusahaan</a></li>
