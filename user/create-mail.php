...
<div class="wrapper">
          ...
          <form action="add-mail.php" method="post">
            <div class="box box-primary">
              ...
              <div class="box-footer">
                ...
                <a href="mailbox.php" class="btn btn-default"><i class="fa fa-times"></i> Hapus</a>
              </div>
              <!-- /.box-footer -->
            </div>
          </form>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="http://simas.masjidarraudhohtelanaipura.net/">Jobs Masjid Ar-Raudhoh</a>.</strong> All rights
    reserved.
    </div>
  </footer>
