...
<div class="wrapper">
          ...
          <div class="col-md-3">
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                ...
                </ul>e-o-right"></i> Keluar</a></li>
                </ul>
              </div>
            </div>
          </div>
          <div class="col-md-9 bg-white padding-2">
            <h2><i>Ubah Password</i></h2>
            <p>Ketikkan kata sandi baru yang ingin Anda gunakan</p>
            <div class="row">
              <div class="col-md-6">
                <form id="changePassword" action="change-password.php" method="post">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-flat btn-success">Ubah Password</button>
                  </div>
              ...
              <div class="col-md-6">
                <form action="deactivate-account.php" method="post">
                  ...
                  <button type="submit" class="btn btn-danger btn-flat btn-lg">Nonaktifkan Akun Saya</button>
                </form>
              </div>
            </div>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="https://simas.masjidarraudhohtelanaipura.net">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
