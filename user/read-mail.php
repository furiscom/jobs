...
<div class="wrapper">
      ...
      <div class="container">
        <div class="row">
          ...
          <section class="content">
            <div class="row">
              <div class="col-md-12">
                <a href="mailbox.php" class="btn btn-default"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="https://masjidarraudhohtelanaipura.net">Jobs Masjid Ar-Raudhoh</a>.</strong> All rights
    reserved.
    </div>
  </footer>
