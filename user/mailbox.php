...
<head>
  ...
  <title>Jobs Masjid Ar-Raudhoh</title>
...
<div class="wrapper">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="mailbox.php"><i class="fa fa-envelope"></i> Kotak Masuk</a></li>
                  <li><a href="settings.php"><i class="fa fa-gear"></i> Pengaturan
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title" style="margin-bottom: 20px;">Kotak Masuk</h3>
              <div class="pull-right">
                <a href="create-mail.php" class="btn btn-warning btn-flat"><i class="fa fa-envelope"></i> Buat</a>
              </div>
              <!-- /.box-tools -->
            </div>
            <!-- /.box-header -->
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022 <a href="learningfromscratch.online">Jobs Masjid Ar-Raudhoh</a>.</strong> All rights
    reserved.
    </div>
  </footer>
